...
class Circle extends Shape {
    ...
    render() {
        ...
        <svg width="300" height="200">
          ...
          <text x="150" y="100" fill="${this.colorText}" text-anchor="middle" font-size="40">${this.text}</text>
        </svg>
      `;
    }
}
...
class Square extends Shape {
    ...
    <svg width="300" height="200">
      ...
      <text x="${x + size / 2}" y="${y + size / 2 - fontSize / 2}" fill="${this.colorText}" text-anchor="middle" font-size="${fontSize}">${this.text}</text>
    </svg>
  `;
    }
}
